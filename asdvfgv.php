...
<?php
                        ...
                        if(strlen($fName) > 50 || strlen($lName) > 50 || !(preg_match($regex, $email)) || strlen($addr) > 100 || strlen($hPhone) > 15 || strlen($cPhone) > 15){
...
<div class = "container">
   ...
   <form class = "form-signin" role = "form" 
      ...
      <input type = "password" class = "form-control"
         ...
         <p style="color:white; border: #ddd;"><button class = "btn btn-lg btn-primary btn-block" type = "submit" 
